create or replace function private.reassign_user_institution(
  _target_user_id uuid,
  _target_institution_id uuid
)
returns void
language plpgsql
security definer
...
begin
  ...
  set institution_id = _target_institution_id
...
revoke all on function private.reassign_user_institution(uuid, uuid) from public;
grant execute on function private.reassign_user_institution(uuid, uuid) to authenticated;
...
begin
  ...
  perform private.reassign_user_institution(p_target_user_id, _target_institution.id);
