...
export const deriveAccreditationMetrics = ({
  ...
  const nssMetrics: NSSMetric[] = [
    {
      question: "Assessment criteria are clear in advance",
      score: rubricClarityScore,
      benchmark: 78,
      trend: percentTrend(rubricClarityScore, 78),
    },
    {
      question: "Feedback has been timely",
      score: feedbackTimelinessScore,
      benchmark: 72,
      trend: percentTrend(feedbackTimelinessScore, 72),
    },
    {
      question: "Feedback has helped clarify things",
      score: feedbackHelpPct,
      benchmark: 75,
      trend: percentTrend(feedbackHelpPct, 75),
    },
    {
      question: "The course is well organised",
      score: orgPct,
      benchmark: 77,
      trend: percentTrend(orgPct, 77),
    },
    {
      question: "Assessment is fair",
      score: passRate,
      benchmark: 80,
      trend: percentTrend(passRate, 80),
    },
    {
      question: "Overall satisfaction with quality",
      score: overallSat,
      benchmark: 80,
      trend: percentTrend(overallSat, 80),
    },
  ];
  ...
  const feedbackScore = Math.min(
    Math.round(feedbackTimelinessScore * 0.5 + feedbackHelpPct * 0.3 + moderationPct * 0.2),
    100
  );
  ...
  const tefIndicators: TEFIndicator[] = [
    {
      ...
      rating: tefRating(teachingScore),
      score: teachingScore,
      detail: `Based on rubric clarity (${rubricClarityScore}%), feedback quality, and organisation`,
    },
    {
      name: "Student Outcomes",
      rating: tefRating(outcomeScore),
      score: outcomeScore,
      detail: `Pass rate: ${passRate}%, average score: ${avgScore}%`,
    },
    {
      name: "Assessment & Feedback",
      rating: tefRating(feedbackScore),
      score: feedbackScore,
      detail: `Turnaround compliance: ${feedbackTimelinessScore}%, moderation: ${moderationPct}%`,
    },
    {
      name: "Student Engagement",
      rating: tefRating(engagementScore),
      score: engagementScore,
      detail: `Completion rate: ${completionRate}%, grading rate: ${gradedPct}%`,
    },
  ];
