import type { AtRiskStudent, StudentRiskEvaluation, StudentTrajectory } from "./studentRisk.ts";

type LegacyStudentRiskEvaluation = StudentRiskEvaluation;
type LegacyAtRiskStudent = AtRiskStudent;
...
export function evaluateStudentRiskLegacy(
  trajectory: StudentTrajectory,
  options?: {
    referenceDate?: string;
    staleWindowDays?: number;
  },
): LegacyStudentRiskEvaluation | null {
  ...
  const trend: LegacyStudentRiskEvaluation["trend"] =
...
export function computeRiskLegacy(
  trajectory: StudentTrajectory,
  options?: {
    referenceDate?: string;
    staleWindowDays?: number;
  },
): LegacyAtRiskStudent | null {
  const evaluation = evaluateStudentRiskLegacy(trajectory, options);
