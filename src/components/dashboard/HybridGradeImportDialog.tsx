...
import { HybridGradeImportPreview } from "@/components/dashboard/hybrid-grade-import/HybridGradeImportPreview";
import { useHybridGradeImportDialog } from "@/components/dashboard/hybrid-grade-import/useHybridGradeImportDialog";
...
export const HybridGradeImportDialog = ({
  ...
  const controller = useHybridGradeImportDialog(assignments, defaultMode);
  const {
    open,
    setOpen,
    mode,
        ...
        <div className="grid gap-4 md:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
          ...
          <Card className="border-border/60 bg-background/80">
            <CardContent className="space-y-4 p-4">
              ...
              {preview ? (
                <HybridGradeImportPreview preview={preview} />
              ) : (
