...
const OverviewCards = ({
  ...
  const cards: AdminOverviewCard[] = [
    ...
    { title: "Workflow Failures", value: formatCount(metrics.aiGradingFailures), helper: "Processing and release error events recorded today and visible to admin.", href: "/dashboard?view=system", icon: ShieldAlert },
