...
import { getLatestModeratorReview, type ModerationAction } from "@/lib/moderation";
import { getModerationDisagreementSummary, getModerationEscalationSummary, type ModerationCaseView } from "@/lib/moderationWorkflow";
  ...
  return (
    <div className="space-y-5 pt-2">
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.9fr)]">
        <ModerationEvidenceSection selectedCase={selectedCase} />
