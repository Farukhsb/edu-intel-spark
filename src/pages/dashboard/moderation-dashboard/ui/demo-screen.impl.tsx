...
import { buildDemoSelectableCaseIds } from "./demo-screen.helpers";
import type { ModerationDashboardScreenProps } from "./screen";
...
export const DemoModerationDashboardScreen = ({
  ...
  const selectableCaseIds = buildDemoSelectableCaseIds({
    bulkApprovableFilteredCases,
    bulkAssignableFilteredCases,
  });
