...
export type ModerationActionsSectionProps = {
...
export const coerceSubmissionStatus = (value: string): SubmissionRow["status"] => value as SubmissionRow["status"];

export const ModerationActionsAssignmentCard = ({
  lecturers,
  moderatorDrafts,
  onAssignModerator,
  ...
  "lecturers" | "moderatorDrafts" | "onAssignModerator" | "onModeratorDraftChange" | "saving" | "selectedCase" | "userId"
>) => {
...
export const ModerationActionsDraftCard = ({
  feedbackDraft,
  noteDraft,
  ...
  ModerationActionsSectionProps,
  "feedbackDraft" | "noteDraft" | "onFeedbackDraftChange" | "onNoteDraftChange" | "onScoreDraftChange" | "scoreDraft" | "selectedCase" | "userId"
>) => {
...
export const ModerationActionsButtonRow = ({
  onSaveAction,
  saving,
  selectedCase,
  userId,
}: Pick<ModerationActionsSectionProps, "onSaveAction" | "saving" | "selectedCase" | "userId">) => (
