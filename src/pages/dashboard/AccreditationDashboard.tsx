...
const DEMO_QAA_METRICS: QAAMetric[] = [
  {
...
const DEMO_NSS_METRICS: NSSMetric[] = [
...
const DEMO_TEF_INDICATORS: TEFIndicator[] = [
  {
...
const DEMO_FEEDBACK_TURNAROUND = { avg: 8, target: 15, compliant: 11, total: 12 };

const DEMO_PROGRAMME_REPORTS: ProgrammeReport[] = [
  {
    code: "PPL502",
    submissions: 6,
    graded: 6,
